import React__default, { Component, createElement, useEffect } from 'react';
import PropTypes from 'prop-types';
import { getEventTransfer, Editor as Editor$1 } from 'slate-react';
import { Editor, Value } from 'slate';
import noop from 'lodash-es/noop';
import debounce from 'lodash-es/debounce';
import { is, List } from 'immutable';
import deepEquals from 'fast-deep-equal';
import { BLOCKS, TOP_LEVEL_BLOCKS, CONTAINERS, INLINES, VOID_BLOCKS, MARKS, EMPTY_DOCUMENT } from '@contentful/rich-text-types';
import { toContentfulDocument, toSlatejsDocument } from '@contentful/contentful-slatejs-adapter';
import { useEntities, MissingEntityCard, WrappedEntryCard, WrappedAssetCard, EntityProvider, getScheduleTooltipContent, ScheduledIconWithTooltip } from '@contentful/field-editor-reference';
import fromPairs from 'lodash-es/fromPairs';
import EditList from '@productboard/slate-edit-list';
import { cx, css } from 'emotion';
import { Button, Tooltip, EntryCard, AssetCard, ModalContent, ModalControls, Form, FormControl, TextInput, Select, FormLabel, TextLink, Menu, Flex, Icon, InlineEntryCard, Text, MenuItem, SectionHeading, IconButton, Spinner, SkeletonContainer, SkeletonBodyText } from '@contentful/f36-components';
import tokens from '@contentful/f36-tokens';
import isHotkey from 'is-hotkey';
import { FormatBoldIcon, FormatItalicIcon, FormatUnderlinedIcon, CodeIcon, QuoteIcon, LinkIcon, ChevronDownIcon, AssetIcon, EmbeddedEntryBlockIcon, EmbeddedEntryInlineIcon, ClockIcon, ListBulletedIcon, ListNumberedIcon, HorizontalRuleIcon, CloseIcon, PlusIcon } from '@contentful/f36-icons';
import camelCase from 'lodash-es/camelCase';
import flow from 'lodash-es/flow';
import find from 'lodash-es/find';
import get from 'lodash-es/get';
import { detect } from 'detect-browser';
import { entityHelpers, FieldConnector, ModalDialogLauncher } from '@contentful/field-editor-shared';
...
var schema = {
  ...
  blocks: /*#__PURE__*/_extends((_extends2 = {}, _extends2[BLOCKS.PARAGRAPH] = {
    nodes: [{
      types: /*#__PURE__*/Object.values(INLINES)
    }, {
      objects: ['text', 'inline']
    }]
  ...
  }, _extends2), /*#__PURE__*/mapVoidTypes(VOID_BLOCKS), listPlugin.schema.blocks, (_extends3 = {}, _extends3[BLOCKS.QUOTE] = {
    nodes: [{
...
function markDecorator (Tag, tagProps) {
  ...
  var CommonMark = function CommonMark(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(Tag, Object.assign({}, tagProps, attributes), children);
  };
  ...
  return function (Mark) {
    ...
    return _temp = _class = /*#__PURE__*/function (_React$Component) {
      ...
      _proto.render = function render() {
        ...
        return /*#__PURE__*/createElement(Mark, {
          type: type,
          title: title,
    ...
    }(Component), _class.propTypes = TOOLBAR_PLUGIN_PROP_TYPES, _temp;
  };
});
...
var Bold$1 = /*#__PURE__*/markToggleDecorator({
  type: MARKS.BOLD,
  title: 'Bold',
  children: /*#__PURE__*/React__default.createElement(FormatBoldIcon, null)
})(Bold);
...
var Italic$1 = /*#__PURE__*/markToggleDecorator({
  type: MARKS.ITALIC,
  title: 'Italic',
  children: /*#__PURE__*/React__default.createElement(FormatItalicIcon, null)
})(Italic);
...
var Underlined$1 = /*#__PURE__*/markToggleDecorator({
  type: MARKS.UNDERLINE,
  title: 'Underline',
  children: /*#__PURE__*/React__default.createElement(FormatUnderlinedIcon, null)
})(Underlined);
...
var Code$1 = /*#__PURE__*/markToggleDecorator({
  type: MARKS.CODE,
  title: 'Code',
  children: /*#__PURE__*/React__default.createElement(CodeIcon, null)
})(Code);
  ...
  return function (Block) {
    ...
    return _temp = _class = /*#__PURE__*/function (_React$Component) {
      ...
      _proto.render = function render() {
        ...
        return /*#__PURE__*/createElement(Block, {
          type: type,
          title: title,
          onToggle: this.handleToggle,
...
var styles$2 = {
  ...
  heading1: /*#__PURE__*/css( /*#__PURE__*/_extends({}, headingCss, {
    fontSize: '1.875rem'
  })),
  heading2: /*#__PURE__*/css( /*#__PURE__*/_extends({}, headingCss, {
    fontSize: '1.5625rem'
  })),
  heading3: /*#__PURE__*/css( /*#__PURE__*/_extends({}, headingCss, {
    fontSize: '1.375rem'
  })),
  heading4: /*#__PURE__*/css( /*#__PURE__*/_extends({}, headingCss, {
    fontSize: '1.25rem'
  })),
  heading5: /*#__PURE__*/css( /*#__PURE__*/_extends({}, headingCss, {
    fontSize: '1.125rem'
  })),
  heading6: /*#__PURE__*/css( /*#__PURE__*/_extends({}, headingCss, {
    fontSize: '1rem'
  }))
};
function commonNode (Tag, tagProps) {
  ...
  var CommonNode = function CommonNode(_ref) {
    ...
    return /*#__PURE__*/createElement(Tag, Object.assign({
      className: styles$2[camelCase(node.type)],
...
var QuotePlugin = /*#__PURE__*/newPlugin(BLOCKS.QUOTE, 'blockquote', ['mod+shift+1']);
...
var Blockquote = /*#__PURE__*/function (_Component) {
  ...
  return Blockquote;
}(Component); // TODO: Currently it seems this is the only place using `blockToggleDecorator` but we still
...
var Quote = /*#__PURE__*/blockToggleDecorator({
  type: BLOCKS.QUOTE,
  title: 'Blockquote',
  children: /*#__PURE__*/React__default.createElement(QuoteIcon, null),
...
var HyperlinkDialog = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.renderFields = function renderFields() {
    ...
    }, allowedHyperlinkTypes.includes(LINK_TYPES.URI) || type === LINK_TYPES.URI ? /*#__PURE__*/React__default.createElement(Select.Option, {
      value: LINK_TYPES.URI
    }, "URL") : null, allowedHyperlinkTypes.includes(LINK_TYPES.ENTRY) || type === LINK_TYPES.ENTRY ? /*#__PURE__*/React__default.createElement(Select.Option, {
      value: LINK_TYPES.ENTRY
    }, "Entry") : null, allowedHyperlinkTypes.includes(LINK_TYPES.ASSET) || type === LINK_TYPES.ASSET ? /*#__PURE__*/React__default.createElement(Select.Option, {
      value: LINK_TYPES.ASSET
    }, "Asset") : null)), type === LINK_TYPES.URI ? /*#__PURE__*/React__default.createElement(FormControl, {
      id: "link-uri",
      isRequired: true
  ...
  _proto.renderEntitySelector = function renderEntitySelector(type) {
    ...
    }, type === LINK_TYPES.ENTRY && /*#__PURE__*/React__default.createElement(TextLink, {
      as: "button",
      onClick: this.selectEntry
    }, "Select entry"), type === LINK_TYPES.ASSET && /*#__PURE__*/React__default.createElement(TextLink, {
      as: "button",
...
var HYPERLINK = INLINES.HYPERLINK,
    ENTRY_HYPERLINK = INLINES.ENTRY_HYPERLINK,
    ASSET_HYPERLINK = INLINES.ASSET_HYPERLINK;
var HYPERLINK_TYPES = [HYPERLINK, ENTRY_HYPERLINK, ASSET_HYPERLINK];
var nodeToHyperlinkType = (_nodeToHyperlinkType = {}, _nodeToHyperlinkType[INLINES.ENTRY_HYPERLINK] = LINK_TYPES.ENTRY, _nodeToHyperlinkType[INLINES.ASSET_HYPERLINK] = LINK_TYPES.ASSET, _nodeToHyperlinkType[INLINES.HYPERLINK] = LINK_TYPES.URI, _nodeToHyperlinkType);

function getAllowedHyperlinkTypes(field) {
  var hyperlinkTypes = [INLINES.ENTRY_HYPERLINK, INLINES.ASSET_HYPERLINK, INLINES.HYPERLINK];
...
function Hyperlink(props) {
  ...
  var requestStatus = useRequestStatus({
    richTextAPI: props.richTextAPI,
    target: target
  });
  ...
  var getTooltipContent = function getTooltipContent() {
    ...
    if (requestStatus.type === 'error') {
      ...
      var _requestStatus$data = requestStatus.data,
          ...
          entityInfo = _objectWithoutPropertiesLoose(_requestStatus$data, _excluded);
  ...
  var renderLink = function renderLink(_ref2) {
    ...
    return /*#__PURE__*/React__default.createElement(Tooltip, {
      ...
      targetWrapperClassName: styles$3.hyperlinkWrapper,
      placement: "bottom",
      maxWidth: "auto"
    }, SUPPORTS_NATIVE_SLATE_HYPERLINKS ? /*#__PURE__*/React__default.createElement(TextLink // Allows user to open uri link in new tab.
    , {
      href: href,
      rel: "noopener noreferrer",
      title: title,
      className: styles$3.hyperlink
    }, children) : /*#__PURE__*/React__default.createElement("span", {
      className: cx(styles$3.hyperlink, styles$3.hyperlinkIEFallback)
    }, children));
  };

  return /*#__PURE__*/React__default.createElement("span", Object.assign({}, props.attributes, {
...
var HYPERLINK$1 = INLINES.HYPERLINK,
    ENTRY_HYPERLINK$1 = INLINES.ENTRY_HYPERLINK,
    ASSET_HYPERLINK$1 = INLINES.ASSET_HYPERLINK;
  ...
  return {
    renderNode: function renderNode(props, _editor, next) {
      ...
      if (isHyperlink(node.type)) {
        return /*#__PURE__*/React__default.createElement(Hyperlink, Object.assign({}, props, {
          richTextAPI: richTextAPI,
...
var ToolbarDropdownListItem = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(Menu.Item, {
      ...
      className: cx(styles$4.root, styles$4[getStyleForType(type)]),
      onClick: this.handleClick
    }, children);
  };
...
var blockTitles = (_blockTitles = {}, _blockTitles[BLOCKS.HEADING_1] = 'Heading 1', _blockTitles[BLOCKS.HEADING_2] = 'Heading 2', _blockTitles[BLOCKS.HEADING_3] = 'Heading 3', _blockTitles[BLOCKS.HEADING_4] = 'Heading 4', _blockTitles[BLOCKS.HEADING_5] = 'Heading 5', _blockTitles[BLOCKS.HEADING_6] = 'Heading 6', _blockTitles[BLOCKS.PARAGRAPH] = 'Normal Text', _blockTitles[BLOCKS.EMBEDDED_ENTRY] = 'Embedded Entry', _blockTitles[BLOCKS.EMBEDDED_ASSET] = 'Embedded Asset', _blockTitles);
...
var HeadingDropdown = /*#__PURE__*/function (_Component) {
  ...
  function HeadingDropdown() {
    ...
    _this.getStyleNameForChange = function () {
      return blockTitles[_this.props.currentBlockType] || blockTitles[BLOCKS.PARAGRAPH];
    };
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(Menu, {
      ...
      onClose: onClose,
      onOpen: onOpen
    }, /*#__PURE__*/React__default.createElement(Menu.Trigger, null, /*#__PURE__*/React__default.createElement(Button, {
      endIcon: /*#__PURE__*/React__default.createElement(ChevronDownIcon, null),
      "data-test-id": "toolbar-heading-toggle",
      className: styles$5.root,
      variant: "transparent",
      size: "small",
      isDisabled: this.props.disabled
    }, this.getStyleNameForChange())), /*#__PURE__*/React__default.createElement(Menu.List, {
...
function newHeadingDropdownItem(nodeType) {
  ...
  var Heading = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      return /*#__PURE__*/React__default.createElement(ToolbarDropdownListItem, Object.assign({}, this.props, {
...
var Paragraph = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    return /*#__PURE__*/React__default.createElement(ToolbarDropdownListItem, this.props, blockTitles[BLOCKS.PARAGRAPH]);
  };
...
var Heading1Plugin = /*#__PURE__*/newPlugin$1(BLOCKS.HEADING_1, 'h1', ['mod+opt+1']);
var Heading2Plugin = /*#__PURE__*/newPlugin$1(BLOCKS.HEADING_2, 'h2', ['mod+opt+2']);
var Heading3Plugin = /*#__PURE__*/newPlugin$1(BLOCKS.HEADING_3, 'h3', ['mod+opt+3']);
var Heading4Plugin = /*#__PURE__*/newPlugin$1(BLOCKS.HEADING_4, 'h4', ['mod+opt+4']);
var Heading5Plugin = /*#__PURE__*/newPlugin$1(BLOCKS.HEADING_5, 'h5', ['mod+opt+5']);
var Heading6Plugin = /*#__PURE__*/newPlugin$1(BLOCKS.HEADING_6, 'h6', ['mod+opt+6']);
var Heading1 = /*#__PURE__*/newHeadingDropdownItem(BLOCKS.HEADING_1);
var Heading2 = /*#__PURE__*/newHeadingDropdownItem(BLOCKS.HEADING_2);
var Heading3 = /*#__PURE__*/newHeadingDropdownItem(BLOCKS.HEADING_3);
var Heading4 = /*#__PURE__*/newHeadingDropdownItem(BLOCKS.HEADING_4);
var Heading5 = /*#__PURE__*/newHeadingDropdownItem(BLOCKS.HEADING_5);
var Heading6 = /*#__PURE__*/newHeadingDropdownItem(BLOCKS.HEADING_6);
...
var EntityLinkToolbarIcon = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return this.props.isButton ? /*#__PURE__*/React__default.createElement(Button, {
      isDisabled: this.props.disabled,
...
var LinkedEntityBlock = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", Object.assign({}, this.props.attributes, {
  ...
  return {
    renderNode: function renderNode(props, _editor, next) {
      ...
      if (node.type === nodeType) {
        return /*#__PURE__*/React__default.createElement(LinkedEntityBlock, Object.assign({
          sdk: sdk
        }, props, attributes, {
...
var EntryLinkToolbarIcon = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return this.props.isButton ? /*#__PURE__*/React__default.createElement(Button, {
      ...
      startIcon: /*#__PURE__*/React__default.createElement(EmbeddedEntryInlineIcon, null),
      variant: "secondary",
      testId: "toolbar-toggle-" + INLINES.EMBEDDED_ENTRY
    }, "Embed inline entry") : /*#__PURE__*/React__default.createElement(Menu.Item, {
      ...
      alignItems: "center",
      flexDirection: "row"
    }, /*#__PURE__*/React__default.createElement(EmbeddedEntryInlineIcon, {
      variant: "secondary",
      className: "rich-text__embedded-entry-list-icon " + styles$8.icon
    }), /*#__PURE__*/React__default.createElement("span", null, "Inline entry")));
  };
...
var FetchingWrappedInlineEntryCard = function FetchingWrappedInlineEntryCard(props) {
  ...
  if (entry === 'failed') {
    return /*#__PURE__*/React__default.createElement(InlineEntryCard, {
      ...
      isSelected: props.isSelected
    }, /*#__PURE__*/React__default.createElement(Text, null, "Entry missing or inaccessible"));
  }
  ...
  return /*#__PURE__*/React__default.createElement(InlineEntryCard, {
    ...
    status: status,
    actions: !props.isReadOnly ? [/*#__PURE__*/React__default.createElement(MenuItem, {
      key: "edit",
      onClick: props.onEdit
    ...
    className: styles$9.scheduledIcon,
    variant: "muted",
    testId: "scheduled-icon"
  })), /*#__PURE__*/React__default.createElement(Text, null, title));
};
...
var EmbeddedEntryInline = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("span", Object.assign({}, this.props.attributes, {
  ...
  return {
    renderNode: function renderNode(props, _editor, next) {
      ...
      if (node.type === INLINES.EMBEDDED_ENTRY) {
        return /*#__PURE__*/React__default.createElement(EmbeddedEntryInline, Object.assign({
          sdk: sdk
        }, props, attributes, {
          onEntityFetchComplete: function onEntityFetchComplete() {
            logViewportAction('linkRendered', {
...
var UnorderedList = /*#__PURE__*/listToggleDecorator({
  type: BLOCKS.UL_LIST,
  title: 'UL',
  children: /*#__PURE__*/React__default.createElement(ListBulletedIcon, null)
})(function (props) {
...
var OrderedList = /*#__PURE__*/listToggleDecorator({
  type: BLOCKS.OL_LIST,
  title: 'OL',
  children: /*#__PURE__*/React__default.createElement(ListNumberedIcon, null)
})(function (props) {
  return /*#__PURE__*/React__default.createElement(ToolbarIcon, props);
});
...
var styles$a = {
  hr: /*#__PURE__*/css(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n    height: ", ";\n    background: transparent;\n    position: relative;\n    margin: 0 0 ", ";\n    &:hover {\n      cursor: pointer;\n    }\n    &::after {\n      content: '';\n      position: absolute;\n      width: 100%;\n      height: 1px;\n      background: ", ";\n      top: 50%;\n    }\n  "])), tokens.spacingM, tokens.spacingL, tokens.gray300),
  hrSelected: /*#__PURE__*/css(_templateObject2 || (_templateObject2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n    &::after {\n      background: ", ";\n      -webkit-box-shadow: 0px 0px 5px ", ";\n      box-shadow: 0px 0px 5px ", ";\n    }\n  "])), tokens.colorPrimary, tokens.colorPrimary, tokens.colorPrimary)
};
var HrPlugin = function HrPlugin() {
  return {
    renderNode: function renderNode(props, _editor, next) {
      if (props.node.type === BLOCKS.HR) {
        return /*#__PURE__*/React__default.createElement("hr", Object.assign({
          className: cx(styles$a.hr, props.isSelected && styles$a.hrSelected)
        }, props.attributes));
      }
...
var Hr$1 = /*#__PURE__*/blockSelectDecorator({
  type: BLOCKS.HR,
  title: 'HR',
  children: /*#__PURE__*/React__default.createElement(HorizontalRuleIcon, null),
...
var gDocsRules = {
  deserialize: function deserialize(el, next) {
    ...
    if (el.tagName.toLowerCase() === 'span') {
      ...
      if (isGoogleBold(el)) {
        _marks.push(MARKS.BOLD);
      }

      if (isGoogleItalic(el)) {
        _marks.push(MARKS.ITALIC);
      }

      if (isGoogleUnderline(el)) {
        _marks.push(MARKS.UNDERLINE);
      }
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        displayTitle = entityHelpers.getEntryTitle({
                          entry: entry,
                          contentType: contentType,
                          localeCode: sdk.field.locale,
                          defaultLocaleCode: sdk.locales["default"],
...
var isEmbeddingEnabled = function isEmbeddingEnabled(field) {
  return isNodeTypeEnabled(field, BLOCKS.EMBEDDED_ASSET) || isNodeTypeEnabled(field, BLOCKS.EMBEDDED_ENTRY) || isNodeTypeEnabled(field, INLINES.EMBEDDED_ENTRY);
};
...
function buildAction(embedType, contentType, actionType, callback) {
  var isAsset = !contentType;
  var isInline = embedType === INLINES.EMBEDDED_ENTRY;
...
var styles$b = {
  ...
  isSelected: /*#__PURE__*/css({
    background: tokens.gray200
  }),
  skeletonContainer: /*#__PURE__*/css({
  ...
  instruction: /*#__PURE__*/css({
    marginRight: 15,
    color: tokens.gray600
  }),
  closeButton: /*#__PURE__*/css({
    marginLeft: 'auto'
  })
};
...
var Instruction = function Instruction(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("span", {
    className: styles$b.instruction
  }, children);
};
...
var CommandPanel = /*#__PURE__*/function (_React$Component2) {
  ...
  function CommandPanel() {
    ...
    _this3.renderNavigationBar = function () {
      return /*#__PURE__*/React__default.createElement("div", {
        className: styles$b.navBar
      }, /*#__PURE__*/React__default.createElement(SectionHeading, {
        marginBottom: "none"
      }, _this3.props.breadcrumb ? "Embed " + _this3.props.breadcrumb : 'Richtext Commands'), /*#__PURE__*/React__default.createElement(IconButton, {
        "aria-label": "Close",
    ...
    _this3.renderStatusBar = function () {
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        className: styles$b.instructions
    ...
    _this3.renderSkeleton = function () {
      return /*#__PURE__*/React__default.createElement("li", {
        className: styles$b.skeletonContainer
      }, /*#__PURE__*/React__default.createElement(SkeletonContainer, null, /*#__PURE__*/React__default.createElement(SkeletonBodyText, {
        numberOfLines: 7
      })));
    };
  ...
  _proto2.renderItems = function renderItems(groupName) {
    ...
    return this.state.items.filter(function (item) {
      ...
      var classNames = cn(styles$b.item, (_cn = {}, _cn[styles$b.isSelected] = isSelected, _cn));
  ...
  _proto2.render = function render() {
    ...
    var classNames = cn(styles$b.commandPanel, className);
    return /*#__PURE__*/React__default.createElement("div", {
      className: classNames
    }, this.renderNavigationBar(), /*#__PURE__*/React__default.createElement("ul", {
      className: styles$b.commandPanelList,
      "data-test-id": testId
...
var _excluded$1 = ["className", "children", "testId", "onOverflowBottom", "onOverflowLeft", "onOverflowRight", "onOverflowTop"];
...
var InViewport = /*#__PURE__*/function (_Component) {
  ...
  function InViewport() {
    ...
    _this.bindEventListeners = function () {
      ...
      if (isBrowser && _this.tGetDomPosition) {
...
var CommandPalette = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function CommandPalette() {
    ...
    _this.requestUpdate = throttle$1(function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                nodeType === INLINES.EMBEDDED_ENTRY ? insertInline(editor, entity.sys.id, false) : insertBlock(editor, nodeType, entity);
        ...
        return runtime_1.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Promise.all([actionBuilder.maybeBuildEmbedAction(BLOCKS.EMBEDDED_ENTRY, contentType, function () {
                  _this.setState({
                  ...
                  _this.clearCommand();
                }), actionBuilder.maybeBuildEmbedAction(INLINES.EMBEDDED_ENTRY, contentType, function () {
                  _this.setState({
                    breadcrumb: contentType.name,
                    isLoading: true
                  });

                  _this.createCommands(contentType, INLINES.EMBEDDED_ENTRY);

                  _this.clearCommand();
                }), actionBuilder.maybeBuildCreateAndEmbedAction(BLOCKS.EMBEDDED_ENTRY, contentType, function () {
                  return _this.onCreateAndEmbedEntity(contentType.sys.id, BLOCKS.EMBEDDED_ENTRY);
                }), actionBuilder.maybeBuildCreateAndEmbedAction(INLINES.EMBEDDED_ENTRY, contentType, function () {
                  return _this.onCreateAndEmbedEntity(contentType.sys.id, INLINES.EMBEDDED_ENTRY);
                })]);
        ...
        return runtime_1.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Promise.all([actionBuilder.maybeBuildEmbedAction(BLOCKS.EMBEDDED_ASSET, null, function () {
                  _this.setState({
                    breadcrumb: 'Asset',
                    isLoading: true
                  });

                  _this.createCommands(null, BLOCKS.EMBEDDED_ASSET);

                  _this.clearCommand();
                }), actionBuilder.maybeBuildCreateAndEmbedAction(BLOCKS.EMBEDDED_ASSET, null, function () {
                  return _this.onCreateAndEmbedEntity(null, BLOCKS.EMBEDDED_ASSET);
                })]);
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React__default.createElement(InViewport, {
...
var EntryEmbedDropdown = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(Menu, {
      ...
      variant: "secondary",
      size: "small",
      startIcon: /*#__PURE__*/React__default.createElement(PlusIcon, null),
      isDisabled: this.props.disabled
    }, "Embed")), /*#__PURE__*/React__default.createElement(Menu.List, {
...
var Toolbar = /*#__PURE__*/function (_React$Component) {
  ...
  function Toolbar() {
    ...
    _this.handleEmbedDropdownOpen = function () {
    ...
    _this.renderEmbeds = function (props) {
      var field = _this.props.richTextAPI.sdk.field;
      var inlineEntryEmbedEnabled = isNodeTypeEnabled(field, INLINES.EMBEDDED_ENTRY);
      var blockEntryEmbedEnabled = isNodeTypeEnabled(field, BLOCKS.EMBEDDED_ENTRY);
      var blockAssetEmbedEnabled = _this.state.canAccessAssets && isNodeTypeEnabled(field, BLOCKS.EMBEDDED_ASSET);
      var numEnabledEmbeds = [inlineEntryEmbedEnabled, blockEntryEmbedEnabled, blockAssetEmbedEnabled].filter(Boolean).length;
      return /*#__PURE__*/React__default.createElement("div", {
        className: styles$c.embedActionsWrapper
      }, numEnabledEmbeds > 1 ? /*#__PURE__*/React__default.createElement(EntryEmbedDropdown, {
        onOpen: _this.handleEmbedDropdownOpen,
        isOpen: _this.state.isEmbedDropdownOpen,
        disabled: props.disabled,
        onClose: _this.handleEmbedDropdownClose
      }, blockEntryEmbedEnabled && /*#__PURE__*/React__default.createElement(EntityLinkToolbarIcon, Object.assign({
        nodeType: BLOCKS.EMBEDDED_ENTRY
      }, props)), inlineEntryEmbedEnabled && /*#__PURE__*/React__default.createElement(EntryLinkToolbarIcon, props), blockAssetEmbedEnabled && /*#__PURE__*/React__default.createElement(EntityLinkToolbarIcon, Object.assign({
        nodeType: BLOCKS.EMBEDDED_ASSET
      }, props))) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, blockEntryEmbedEnabled && /*#__PURE__*/React__default.createElement(EntityLinkToolbarIcon, Object.assign({
        nodeType: BLOCKS.EMBEDDED_ENTRY,
        isButton: true
      }, props)), inlineEntryEmbedEnabled && /*#__PURE__*/React__default.createElement(EntryLinkToolbarIcon, Object.assign({
        isButton: true
      }, props)), blockAssetEmbedEnabled && /*#__PURE__*/React__default.createElement(EntityLinkToolbarIcon, Object.assign({
        nodeType: BLOCKS.EMBEDDED_ASSET,
        isButton: true
      }, props))));
    };

    _this.openHeadingMenu = function () {
      return _this.setState({
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(Flex, {
      ...
      className: styles$c.formattingOptionsWrapper
      ...
      disabled: props.disabled
    }, /*#__PURE__*/React__default.createElement(Paragraph$1, props), isNodeTypeEnabled(field, BLOCKS.HEADING_1) && /*#__PURE__*/React__default.createElement(Heading1, props), isNodeTypeEnabled(field, BLOCKS.HEADING_2) && /*#__PURE__*/React__default.createElement(Heading2, props), isNodeTypeEnabled(field, BLOCKS.HEADING_3) && /*#__PURE__*/React__default.createElement(Heading3, props), isNodeTypeEnabled(field, BLOCKS.HEADING_4) && /*#__PURE__*/React__default.createElement(Heading4, props), isNodeTypeEnabled(field, BLOCKS.HEADING_5) && /*#__PURE__*/React__default.createElement(Heading5, props), isNodeTypeEnabled(field, BLOCKS.HEADING_6) && /*#__PURE__*/React__default.createElement(Heading6, props)), isAnyMarkEnabled && /*#__PURE__*/React__default.createElement("span", {
      className: styles$c.divider,
      "data-test-id": "mark-divider"
    }), isMarkEnabled(field, MARKS.BOLD) && /*#__PURE__*/React__default.createElement(Bold$1, props), isMarkEnabled(field, MARKS.ITALIC) && /*#__PURE__*/React__default.createElement(Italic$1, props), isMarkEnabled(field, MARKS.UNDERLINE) && /*#__PURE__*/React__default.createElement(Underlined$1, props), isMarkEnabled(field, MARKS.CODE) && /*#__PURE__*/React__default.createElement(Code$1, props), isAnyHyperlinkEnabled && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("span", {
      className: styles$c.divider,
      "data-test-id": "hyperlink-divider"
    }), /*#__PURE__*/React__default.createElement(HyperlinkToolbarIcon, props)), isAnyListEnabled && /*#__PURE__*/React__default.createElement("span", {
      className: styles$c.divider,
      "data-test-id": "list-divider"
    }), isNodeTypeEnabled(field, BLOCKS.UL_LIST) && /*#__PURE__*/React__default.createElement(UnorderedList, props), isNodeTypeEnabled(field, BLOCKS.OL_LIST) && /*#__PURE__*/React__default.createElement(OrderedList, props), isNodeTypeEnabled(field, BLOCKS.QUOTE) && /*#__PURE__*/React__default.createElement(Quote, props), isNodeTypeEnabled(field, BLOCKS.HR) && /*#__PURE__*/React__default.createElement(Hr$1, props)), this.renderEmbeds(props));
  };
...
function getValidationInfo(field) {
  var isAnyMarkEnabled = isMarkEnabled(field, MARKS.BOLD) || isMarkEnabled(field, MARKS.ITALIC) || isMarkEnabled(field, MARKS.UNDERLINE) || isMarkEnabled(field, MARKS.CODE);
  var isAnyHyperlinkEnabled = isNodeTypeEnabled(field, INLINES.HYPERLINK) || isNodeTypeEnabled(field, INLINES.ASSET_HYPERLINK) || isNodeTypeEnabled(field, INLINES.ENTRY_HYPERLINK);
  var isAnyListEnabled = isNodeTypeEnabled(field, BLOCKS.UL_LIST) || isNodeTypeEnabled(field, BLOCKS.OL_LIST) || isNodeTypeEnabled(field, BLOCKS.QUOTE) || isNodeTypeEnabled(field, BLOCKS.HR);
  return {
...
var styles$d = {
  nativeSticky: /*#__PURE__*/css(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n    position: -webkit-sticky;\n    position: sticky;\n    top: -1px;\n    z-index: 2;\n  "])))
};
...
var StickyToolbarWrapper = function StickyToolbarWrapper(_ref) {
  var isDisabled = _ref.isDisabled,
      children = _ref.children;
  return /*#__PURE__*/React__default.createElement("div", {
    className: isDisabled ? '' : styles$d.nativeSticky
  }, children);
};
...
var _excluded$2 = ["sdk", "isInitiallyDisabled"];
...
var EMPTY_SLATE_DOCUMENT = /*#__PURE__*/createSlateValue(EMPTY_DOCUMENT);
var ConnectedRichTextEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function ConnectedRichTextEditor() {
    ...
    _this.state = {
      lastOperations: List(),
      value: _this.props.value && _this.props.value.nodeType === BLOCKS.DOCUMENT ? createSlateValue(_this.props.value) : EMPTY_SLATE_DOCUMENT
    };
  ...
  _proto.render = function render() {
    var classNames = cx(styles$e.editor, this.props.minHeight !== undefined ? css({
      minHeight: this.props.minHeight
    }) : undefined, this.props.isDisabled ? styles$e.disabled : styles$e.enabled, this.props.isToolbarHidden && styles$e.hiddenToolbar);
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      editor: this.editor.current || new Editor({
        readOnly: true
      }),
...
function RichTextEditor(props) {
  ...
  return /*#__PURE__*/React__default.createElement(EntityProvider, {
    sdk: sdk
  }, "Example test", /*#__PURE__*/React__default.createElement(FieldConnector, {
    throttle: 0,
    field: sdk.field,
